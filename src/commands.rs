...
use crate::commands_mutate::{cmd_add, cmd_rm, cmd_set_enabled};
use crate::commands_portable::{cmd_backup, cmd_export, cmd_import, cmd_restore};
use crate::commands_preset::{cmd_preset_add, cmd_preset_list};
...
pub(crate) fn run(cli: crate::cli::Cli) -> ExitCode {
    ...
    match cmd {
        ...
        Cmd::Summary { strict } => cmd_summary(&ctx, strict),
