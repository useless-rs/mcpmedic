//! Stdio probe: spawn a local MCP server, run the discover/initialize
//! handshake, and count tools. Strict per-phase timeouts; the child is
//! always reaped.
//!
//! Split out of [`crate::probe`].
...
mod tests {
    ...
    use crate::probe::{ProbeBudget, probe_transport};
